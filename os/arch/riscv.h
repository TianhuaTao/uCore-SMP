...
static inline void w_sip(uint64 x) { asm volatile("csrw sip, %0"
                                                  :
                                                  : "r"(x)); }
...
static inline void w_mie(uint64 x) { asm volatile("csrw mie, %0"
                                                  :
                                                  : "r"(x)); }
...
static inline void w_tp(uint64 x) { asm volatile("mv tp, %0"
                                                 :
                                                 : "r"(x)); }
